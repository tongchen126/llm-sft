...
def main(model_path, dataset_path, load_json = None):
    ...
    if args.load_json is None:
        # Load dataset
        dataset = evaluator.load_dataset(args.dataset_path, args.image_base_path,max_samples=args.max_samples)
...
if __name__ == "__main__":
    main('/workspace/user_code/workspace/LLaMA-Factory/saved/qwen2_5vl-7b/lora/sft-0/', 
        '/workspace/user_code/workspace/llm-sft/data/pokemon', load_json = "tmp/evaluation_results.json")
